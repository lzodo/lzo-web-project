...
- Server rendered DOM:`,
	...
	function createRenderer(options) {
		console.log(options, "============createRenderer options");
		console.log(
			baseCreateRenderer(options),
			"============baseCreateRenderer result"
		);
	...
	function baseCreateRenderer(options, createHydrationFns) {
		console.log(options, "============baseCreateRenderer options");
		console.log(
			createHydrationFns,
			"============baseCreateRenderer createHydrationFns"
		);
...
Component that was made reactive: `,
	...
	const createApp = (...args) => {
		...
		console.log(args, "======================createApp args");
		console.log(app, "======================ensureRenderer result");
